...
/// since:
/// 4.17.0
@property (nonatomic, strong) SBDMessageTemplateInfo * _Nullable messageTemplateInfo;
...
/// since:
/// 3.0.157
@property (nonatomic, readonly) int64_t messageOffsetTimestamp;
...
/// since:
/// 4.17.0
SWIFT_CLASS_NAMED("MessageTemplate")
@interface SBDMessageTemplate : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull jsonPayload;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.17.0
SWIFT_CLASS_NAMED("MessageTemplateInfo")
@interface SBDMessageTemplateInfo : NSObject
@property (nonatomic, copy) NSString * _Nullable templateListToken;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.17.0
SWIFT_CLASS_NAMED("MessageTemplateList")
@interface SBDMessageTemplateList : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull jsonPayload;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// since:
/// 4.17.0
SWIFT_CLASS_NAMED("MessageTemplateListParams")
@interface SBDMessageTemplateListParams : NSObject
@property (nonatomic) BOOL reverse;
@property (nonatomic) NSInteger limit;
/// Default constructor.
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithBuilder:(SWIFT_NOESCAPE void (^ _Nonnull)(SBDMessageTemplateListParams * _Nonnull))builder OBJC_DESIGNATED_INITIALIZER;
@end



@interface SBDMessageTemplateListParams (SWIFT_EXTENSION(SendbirdChatSDK))
- (BOOL)isEqual:(id _Nullable)object SWIFT_WARN_UNUSED_RESULT;
@end


@interface SBDMessageTemplateListParams (SWIFT_EXTENSION(SendbirdChatSDK)) <NSCopying>
- (id _Nonnull)copyWithZone:(struct _NSZone * _Nullable)zone SWIFT_WARN_UNUSED_RESULT;
@end
...
/// since:
/// 4.17.0
+ (void)getMessageTemplateListWithToken:(NSString * _Nullable)token params:(SBDMessageTemplateListParams * _Nonnull)params completionHandler:(void (^ _Nonnull)(SBDMessageTemplateList * _Nullable, BOOL, NSString * _Nullable, SBError * _Nullable))completionHandler;
/// since:
/// 4.17.0
+ (void)getMessageTemplateWithKey:(NSString * _Nonnull)key completionHandler:(void (^ _Nonnull)(SBDMessageTemplate * _Nullable, SBError * _Nullable))completionHandler;
